...
namespace App\Controller\Authentification\ResetPassword;
...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('bloom-atelier@live.fr', 'Sarah Thomas'))
            ->to((string) $user->getEmail())
            ->subject('Demande de réinitialisation de votre mot de passe.')
            ->htmlTemplate('emails/request_password_email.html.twig')
            ->context([
                'resetToken' => $resetToken,
            ])
        ;
